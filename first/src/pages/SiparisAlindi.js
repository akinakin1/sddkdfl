    ...
    return (
        <div className="siparis-container">
            ...
            <div className="order-details">
                ...
                <p>Ek Malzemeler: {Object.keys(orderData.extraIngredients).filter(ingredient => orderData.extraIngredients[ingredient]).join(", ")}</p>            </div>

            <div className="order-summary">
                <h4>Sipariş Toplamı</h4>
                <p>Seçimler: {Object.values(orderData.extraIngredients).filter(Boolean).length * 5}₺</p>
